...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white rounded-md">
      <div className="p-3">
        <div className="h-48 flex justify-center items-center  border-[rgba(55,73,187,.03)] border-b-[3px] mb-2">
          <img
            src={productImage[0]}
            alt="Product Img"
            className="h-[190px] block ml-auto mr-auto mb-auto mt-auto "
          />
        </div>
        <div className="h-36">
          <Link
